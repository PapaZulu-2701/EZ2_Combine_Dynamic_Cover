...
public:
	...
	bool			DynamicPropCover(); // [MODIFICATION-Dynamic Cover] -  Dynamic Cover
	int				CountNPCsUsingProp(CBaseEntity* pProp); // [MODIFICATION-Dynamic Cover] -  Dynamic Cover
...
private:
	...
	enum
	{
		...
		SCHED_COMBINE_MOVE_TO_HIGH_COVER,	// [MODIFICATION-Dynamic Cover] -  Dynamic Cover
		SCHED_COMBINE_MOVE_TO_LOW_COVER,	// [MODIFICATION-Dynamic Cover] -  Dynamic Cover
#ifdef EZ
	...
	enum
	{
		...
		TASK_COMBINE_MOVE_TO_HIGH_COVER, // [MODIFICATION-Dynamic Cover] -  Dynamic Cover
		TASK_COMBINE_MOVE_TO_LOW_COVER, // [MODIFICATION-Dynamic Cover] -  Dynamic Cover
	...
	enum Combine_Conds
	{
		...
		COND_COMBINE_HAS_HIGH_COVER, // [MODIFICATION-Dynamic Cover] -  Dynamic Cover
		COND_COMBINE_HAS_LOW_COVER, // [MODIFICATION-Dynamic Cover] -  Dynamic Cover
#ifdef EZ2
